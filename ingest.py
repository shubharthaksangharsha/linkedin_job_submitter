...
def load_embedding_model(model_name="nomic-embed-text:latest"):
...
def menu():
    ...
    print('Type clear_history to clear the chat history.')
...
template2 = """
    ...
    * Do not explain the answer just write the JSON format.
